### generated by caffe2fluid, your net is in class "VGG_ILSVRC_16_layers" ###
...
class VGG_ILSVRC_16_layers(Network):
    ...
    inputs_info = {"data": [3, 224, 224]}
    custom_layers_path = "/data3/NLP/NLPfromScratch/caffe2fluid/kaffe"
    ...
    def custom_layer_factory(self):
        ...
        location = VGG_ILSVRC_16_layers.custom_layers_path
        pk_dir = os.path.join(VGG_ILSVRC_16_layers.custom_layers_path, pk_name)
        pk_paths.append((location, pk_dir))
    ...
    def setup(self):
        ...
        self.max_pool(2, 2, 2, 2, True, name='pool3')
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv4_1')
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv4_2')
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv4_3')
        self.max_pool(2, 2, 2, 2, True, name='pool4')
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv5_1')
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv5_2')
        self.conv(3, 3, 512, 1, 1, padding=[1, 1], name='conv5_3')
        self.max_pool(2, 2, 2, 2, True, name='pool5')
        self.fc(4096, name='fc6')
        self.dropout(0.5, name='drop6')
        self.fc(4096, name='fc7')
        self.dropout(0.5, name='drop7')
        self.fc(1000, relu=False, name='fc8')
...
def main():
    ...
    ret = VGG_ILSVRC_16_layers.convert(npy_weight, fluid_model, outputs)
    if ret == 0:
